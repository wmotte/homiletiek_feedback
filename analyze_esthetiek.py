...
def analyze_sermon_esthetiek(text, prompt_template, word_count):
    """
    ...
    # Use gemini-3.1-pro-preview for high quality aesthetic analysis
...
Gebaseerd op het werk van:
  ...
  Paul Scott Wilson, Thomas Long, Marilyn Chandler McEntyre
    ...
    try:
        ...
        json_response = analyze_sermon_esthetiek(sermon_text, prompt_template, word_count)
